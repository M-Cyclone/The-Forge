...
//
    ...
    defined(_CPPLIB_VER) // __FLT_MIN__ detects if it's really GCC/clang and not a mimic. _CPPLIB_VER (Dinkumware)
                         // covers VC++, and Microsoft platforms.
...
namespace eastl
{
	...
	namespace Internal
	{
		...
		struct numeric_limits_base
		{
			...
			// Floating types: the number of digits in the mantissa of T (same as FLT_MANT_DIG, DBL_MANT_DIG or
			// LDBL_MANT_DIG).
			...
			// The number of decimal digits required to make sure that two distinct values of the type have distinct
			...
			// In practice the application or OS can change this at runtime via hardware-specific commands or via
	...
	public:
		...
		static value_type min() { return value_type(0); }

		static value_type max() { return value_type(0); }

		static value_type lowest() { return min(); }

		static value_type epsilon() { return value_type(0); }

		static value_type round_error() { return value_type(0); }

		static value_type denorm_min() { return value_type(0); }

		static value_type infinity() { return value_type(0); }

		static value_type quiet_NaN() { return value_type(0); }

		static value_type signaling_NaN() { return value_type(0); }
	};
	...
	struct numeric_limits<bool>
	{
		...
		static EA_CONSTEXPR_OR_CONST bool is_modulo = false;
		static EA_CONSTEXPR_OR_CONST bool traps = true; // Should this be true or false? Given that it's implemented in
		                                                // hardware as an integer type, we use true.
		static EA_CONSTEXPR_OR_CONST bool tinyness_before = false;
		static EA_CONSTEXPR_OR_CONST float_round_style round_style = round_toward_zero;
		static EA_CONSTEXPR_OR_CONST bool has_infinity = false;
		static EA_CONSTEXPR_OR_CONST bool has_quiet_NaN = false;
		...
		static EA_CONSTEXPR value_type min() { return false; }

		static EA_CONSTEXPR value_type max() { return true; }

		static EA_CONSTEXPR value_type lowest() { return false; }

		static EA_CONSTEXPR value_type epsilon() { return false; }

		static EA_CONSTEXPR value_type round_error() { return false; }

		static EA_CONSTEXPR value_type infinity() { return value_type(); }

		static EA_CONSTEXPR value_type quiet_NaN() { return value_type(); }

		static EA_CONSTEXPR value_type signaling_NaN() { return value_type(); }

		static EA_CONSTEXPR value_type denorm_min() { return value_type(); }
	};
	...
	struct numeric_limits<char>
	{
		...
		static EA_CONSTEXPR value_type min() { return EASTL_LIMITS_MIN(value_type); }

		static EA_CONSTEXPR value_type max() { return EASTL_LIMITS_MAX(value_type); }

		static EA_CONSTEXPR value_type lowest() { return EASTL_LIMITS_MIN(value_type); }

		static EA_CONSTEXPR value_type epsilon() { return 0; }

		static EA_CONSTEXPR value_type round_error() { return 0; }

		static EA_CONSTEXPR value_type infinity()
		{
			return value_type();
		} // Question: Should we return 0 here or value_type()?

		static EA_CONSTEXPR value_type quiet_NaN() { return value_type(); }

		static EA_CONSTEXPR value_type signaling_NaN() { return value_type(); }

		static EA_CONSTEXPR value_type denorm_min() { return (value_type)0; }
	};
	...
	struct numeric_limits<unsigned char>
	{
		...
		static EA_CONSTEXPR value_type min() { return 0; }

		static EA_CONSTEXPR value_type max() { return EASTL_LIMITS_MAX_U(value_type); }

		static EA_CONSTEXPR value_type lowest() { return 0; }
	...
	struct numeric_limits<signed char>
	{
		...
		static EA_CONSTEXPR value_type min() { return EASTL_LIMITS_MIN_S(value_type); }

		static EA_CONSTEXPR value_type max() { return EASTL_LIMITS_MAX_S(value_type); }

		static EA_CONSTEXPR value_type lowest() { return EASTL_LIMITS_MIN_S(value_type); }
	...
	// unique type under VC++.
	// http://social.msdn.microsoft.com/Forums/en-US/vclanguage/thread/9059330a-7cce-4d0d-a8e0-e1dcb63322bd/
	template <>
	...
	struct numeric_limits<char8_t>
	{
		...
		static EA_CONSTEXPR value_type infinity() { return 0; }

		static EA_CONSTEXPR value_type quiet_NaN() { return 0; }

		static EA_CONSTEXPR value_type signaling_NaN() { return 0; }
	...
	struct numeric_limits<unsigned short>
	{
		...
		static EA_CONSTEXPR value_type denorm_min() { return static_cast<value_type>(0); }
	};
	...
	struct numeric_limits<signed int>
	{
		...
		{
			return INT_MIN;
		} // It's hard to get EASTL_LIMITS_MIN_S to work with all compilers here.

		static EA_CONSTEXPR value_type max() { return EASTL_LIMITS_MAX_S(value_type); }

		static EA_CONSTEXPR value_type lowest() { return INT_MIN; }
	...
	struct numeric_limits<signed long>
	{
		...
		static EA_CONSTEXPR value_type lowest() { return LONG_MIN; }
    ...
    (defined(EA_COMPILER_GNUC) || defined(__clang__)) // If __int128_t/__uint128_t is supported...
	...
	struct numeric_limits<float>
	{
		...
		static EA_CONSTEXPR_OR_CONST float_denorm_style has_denorm =
		    denorm_present;                                         // This may be wrong for some platforms.
...
#if EASTL_CUSTOM_FLOAT_CONSTANTS_REQUIRED
		static value_type min() { return FLT_MIN; }

		static value_type max() { return FLT_MAX; }

		static value_type lowest() { return -FLT_MAX; }

		static value_type epsilon() { return FLT_EPSILON; }

		static value_type round_error() { return 0.5f; }

		static value_type infinity() { return Internal::gFloatInfinity; }

		static value_type quiet_NaN() { return Internal::gFloatNaN; }

		static value_type signaling_NaN() { return Internal::gFloatSNaN; }

		static value_type denorm_min() { return Internal::gFloatDenorm; }

#elif (defined(EA_COMPILER_GNUC) || defined(__clang__)) && defined(__FLT_MIN__)
		static EA_CONSTEXPR value_type min() { return __FLT_MIN__; }

		static EA_CONSTEXPR value_type max() { return __FLT_MAX__; }

		static EA_CONSTEXPR value_type lowest() { return -__FLT_MAX__; }

		static EA_CONSTEXPR value_type epsilon() { return __FLT_EPSILON__; }

		static EA_CONSTEXPR value_type round_error() { return 0.5f; }

		static EA_CONSTEXPR value_type infinity() { return __builtin_huge_valf(); }

		static EA_CONSTEXPR value_type quiet_NaN() { return __builtin_nanf(""); }

		static EA_CONSTEXPR value_type signaling_NaN() { return __builtin_nansf(""); }

		static EA_CONSTEXPR value_type denorm_min() { return __FLT_DENORM_MIN__; }
		...
		static value_type infinity() { return __builtin_huge_valf(); }

		static value_type quiet_NaN() { return __builtin_nanf("0"); }

		static value_type signaling_NaN() { return __builtin_nansf("1"); }

		static value_type denorm_min() { return FLT_TRUE_MIN; }
#else
		static value_type infinity() { return _CSTD _FInf._Float; }

		static value_type quiet_NaN() { return _CSTD _FNan._Float; }

		static value_type signaling_NaN() { return _CSTD _FSnan._Float; }

		static value_type denorm_min() { return _CSTD _FDenorm._Float; }
#endif
...
#if EASTL_CUSTOM_FLOAT_CONSTANTS_REQUIRED
		static value_type min() { return DBL_MIN; }

		static value_type max() { return DBL_MAX; }

		static value_type lowest() { return -DBL_MAX; }

		static value_type epsilon() { return DBL_EPSILON; }

		static value_type round_error() { return 0.5f; }

		static value_type infinity() { return Internal::gDoubleInfinity; }

		static value_type quiet_NaN() { return Internal::gDoubleNaN; }

		static value_type signaling_NaN() { return Internal::gDoubleSNaN; }

		static value_type denorm_min() { return Internal::gDoubleDenorm; }

#elif (defined(EA_COMPILER_GNUC) || defined(__clang__)) && defined(__DBL_MIN__)
		static EA_CONSTEXPR value_type min() { return __DBL_MIN__; }

		static EA_CONSTEXPR value_type max() { return __DBL_MAX__; }

		static EA_CONSTEXPR value_type lowest() { return -__DBL_MAX__; }

		static EA_CONSTEXPR value_type epsilon() { return __DBL_EPSILON__; }

		static EA_CONSTEXPR value_type round_error() { return 0.5f; }

		static EA_CONSTEXPR value_type infinity() { return __builtin_huge_val(); }

		static EA_CONSTEXPR value_type quiet_NaN() { return __builtin_nan(""); }

		static EA_CONSTEXPR value_type signaling_NaN() { return __builtin_nans(""); }

		static EA_CONSTEXPR value_type denorm_min() { return __DBL_DENORM_MIN__; }
...
#if defined(_MSVC_STL_UPDATE) && _MSVC_STL_UPDATE >= 202206L // If using a recent version of MSVC's STL...
		static value_type infinity() { return __builtin_huge_val(); }

		static value_type quiet_NaN() { return __builtin_nan("0"); }

		static value_type signaling_NaN() { return __builtin_nans("1"); }

		static value_type denorm_min() { return DBL_TRUE_MIN; }
#else
		static value_type infinity() { return _CSTD _Inf._Double; }

		static value_type quiet_NaN() { return _CSTD _Nan._Double; }

		static value_type signaling_NaN() { return _CSTD _Snan._Double; }

		static value_type denorm_min() { return _CSTD _Denorm._Double; }
#endif
	...
	struct numeric_limits<long double>
	{
...
#if EASTL_CUSTOM_FLOAT_CONSTANTS_REQUIRED
		static value_type min() { return LDBL_MIN; }

		static value_type max() { return LDBL_MAX; }

		static value_type lowest() { return -LDBL_MAX; }

		static value_type epsilon() { return LDBL_EPSILON; }

		static value_type round_error() { return 0.5f; }

		static value_type infinity() { return Internal::gLongDoubleInfinity; }

		static value_type quiet_NaN() { return Internal::gLongDoubleNaN; }

		static value_type signaling_NaN() { return Internal::gLongDoubleSNaN; }

		static value_type denorm_min() { return Internal::gLongDoubleDenorm; }

#elif (defined(EA_COMPILER_GNUC) || defined(__clang__)) && defined(__LDBL_MIN__)
		static EA_CONSTEXPR value_type min() { return __LDBL_MIN__; }

		static EA_CONSTEXPR value_type max() { return __LDBL_MAX__; }

		static EA_CONSTEXPR value_type lowest() { return -__LDBL_MAX__; }

		static EA_CONSTEXPR value_type epsilon() { return __LDBL_EPSILON__; }
		...
		static EA_CONSTEXPR value_type denorm_min() { return __LDBL_DENORM_MIN__; }
		...
		static value_type denorm_min() { return LDBL_TRUE_MIN; }
#else
		static value_type infinity() { return _CSTD _LInf._Long_double; }

		static value_type quiet_NaN() { return _CSTD _LNan._Long_double; }

		static value_type signaling_NaN() { return _CSTD _LSnan._Long_double; }

		static value_type denorm_min() { return _CSTD _LDenorm._Long_double; }
#endif
